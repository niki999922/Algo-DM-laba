...
import ru.ifmo.antll1.Grammar;
import ru.ifmo.antll1.Rule;
...
public class InputGrammarParserParser extends Parser {
	...
	public final GrammarFileContext grammarFile() throws RecognitionException {
		...
		try {
			...
			((GrammarFileContext)_localctx).ig = ignoreTokens();
			      ...
			      _localctx.grammar.headers.add(((GrammarFileContext)_localctx).h.list);
			      _localctx.grammar.startRule = ((GrammarFileContext)_localctx).sr.name;
			      _localctx.grammar.rules.add(((GrammarFileContext)_localctx).r.list);
			      _localctx.grammar.tokens.add(((GrammarFileContext)_localctx).t.list);
			      _localctx.grammar.ignore.add(((GrammarFileContext)_localctx).ig.list);
	...
	public final GrammarNameContext grammarName() throws RecognitionException {
		...
		try {
			...
			((GrammarNameContext)_localctx).w2 = match(WORD);
			 ((GrammarNameContext)_localctx).name =  ((GrammarNameContext)_localctx).w2; 
			setState(35);
			match(SEMICOLON);
			}
		}
			...
			case HEADERS:
				...
				while (_la==IMPORT) {
					...
					((HeadersContext)_localctx).importW = match(WORD);
					 listRes.add(((HeadersContext)_localctx).importW); 
					setState(44);
					match(SEMICOLON);
					}
					}
	...
	public final StartRuleContext startRule() throws RecognitionException {
		...
		try {
			...
			((StartRuleContext)_localctx).w2 = match(WORD);
			 ((StartRuleContext)_localctx).name =  ((StartRuleContext)_localctx).w2; 
			setState(58);
			match(SEMICOLON);
			}
		}
	...
	public final RuleQContext ruleQ() throws RecognitionException {
		...
		try {
			...
			((RuleQContext)_localctx).ruleq =  new Rule(((RuleQContext)_localctx).w1);
			setState(78);
			match(OPEN_BRACKET);
			setState(79);
			...
			((RuleQContext)_localctx).ret = returnValue();
			 _localctx.ruleq.parameters.add(((RuleQContext)_localctx).par.list); _localctx.ruleq.returnType = ((RuleQContext)_localctx).ret.returnType; 
			setState(84);
			match(COLON);
			setState(96);
			_errHandler.sync(this);
			...
			if (_la==WORD || _la==CODE) {
				...
				((RuleQContext)_localctx).c1 = condition();
				 _localctx.ruleq.conditions.add(((RuleQContext)_localctx).c1.cond); 
				setState(93);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==OR) {
					...
					((RuleQContext)_localctx).c2 = condition();
					 _localctx.ruleq.conditions.add(((RuleQContext)_localctx).c2.cond); 
					}
					}
					setState(95);
					_errHandler.sync(this);
		...
		try {
			...
			case WORD:
				...
				((ParametersContext)_localctx).type1 = match(WORD);
				 listRes.add(new Parameter(((ParametersContext)_localctx).var1, ((ParametersContext)_localctx).type1)); 
				setState(113);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
					...
					((ParametersContext)_localctx).type2 = match(WORD);
					 listRes.add(new Parameter(((ParametersContext)_localctx).var2, ((ParametersContext)_localctx).type2)); 
					}
					}
					setState(115);
					_errHandler.sync(this);
	...
	public final ReturnValueContext returnValue() throws RecognitionException {
		...
		try {
			...
			((ReturnValueContext)_localctx).type1 = match(WORD);
			 ((ReturnValueContext)_localctx).returnType =  new ReturnField(((ReturnValueContext)_localctx).var1, ((ReturnValueContext)_localctx).type1); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				((ConditionContext)_localctx).s = step();
				 listRest.add(((ConditionContext)_localctx).s.stepq) 
				}
				}
				setState(130); 
				_errHandler.sync(this);
			 ...
			 ((ConditionContext)_localctx).cond =  new Condition().add(listRes); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case 1:
				...
				((StepContext)_localctx).c = match(CODE);
				 ((StepContext)_localctx).stepq =  new CodeStep(((StepContext)_localctx).c); 
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				((StepContext)_localctx).w1 = match(WORD);
				 ((StepContext)_localctx).stepq =  new RunTermStep("", ((StepContext)_localctx).w1); 
				}
				break;
			case 3:
				...
				((StepContext)_localctx).w2 = match(WORD);
				 ((StepContext)_localctx).stepq =  new RunTermStep(((StepContext)_localctx).w1, ((StepContext)_localctx).w2); 
				}
				break;
			case 4:
				...
				setState(144);
				((StepContext)_localctx).w2 = match(WORD);
				 String tmp_str = ((StepContext)_localctx).w2 + "("; 
				setState(146);
				match(OPEN_BRACKET);
				setState(157);
				_errHandler.sync(this);
				...
				if (_la==WORD) {
					...
					((StepContext)_localctx).w3 = match(WORD);
					 tmp_str = tmp_str + ((StepContext)_localctx).w3; 
					setState(154);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						...
						((StepContext)_localctx).w4 = match(WORD);
						 tmp_str = tmp_str + ", " + ((StepContext)_localctx).w4; 
						}
						}
						setState(156);
						_errHandler.sync(this);
				...
				setState(159);
				match(CLOSE_BRACKET);
				 tmp_str = tmp_str + ")"; ((StepContext)_localctx).stepq =  new RunTermStep(((StepContext)_localctx).w1, tmp_str); 
				}
				break;
			case 5:
				...
				setState(176);
				match(CLOSE_BRACKET);
				 tmp_str = tmp_str + ")"; ((StepContext)_localctx).stepq =  new RunTermStep("", tmp_str); 
				}
				break;
			}
		}
	...
	public final TokensssContext tokensss() throws RecognitionException {
		...
		try {
			...
			case IGNORE:
				enterOuterAlt(_localctx, 1);
				{
				 ((TokensssContext)_localctx).list =  new ArrayList<Token>(); 
				}
				break;
			case TOKENS:
				enterOuterAlt(_localctx, 2);
				...
				setState(181);
				match(TOKENS);
				 ArrayList<Token> listRes = new ArrayList<>(); 
				setState(183);
				match(OPEN_CLOSURE);
				setState(191);
				_errHandler.sync(this);
				...
				while (_la==WORD) {
					...
					((TokensssContext)_localctx).regexp = match(REGEXP);
					 listRes.add(new Token(((TokensssContext)_localctx).tokenName, ((TokensssContext)_localctx).regexp)); 
					setState(188);
					match(SEMICOLON);
					}
					}
				...
				if (_la==WORD) {
					...
					while (_la==COMMA) {
						...
						((IgnoreTokensContext)_localctx).w2 = match(WORD);
						 listRes.add(new Ignore(((IgnoreTokensContext)_localctx).w2)); 
						}
						}
						setState(210);
						_errHandler.sync(this);
					...
					setState(211);
					match(SEMICOLON);
					 listRes.add(new Ignore(((IgnoreTokensContext)_localctx).w1)); 
					}
				}
	...
	public static final String _serializedATN =
		...
		"\2\u00ca\u00cb\b\r\1\2\u00cb\u00d7\7\f\2\2\u00cc\u00d2\7\24\2\2\u00cd"+
		"\u00ce\7\21\2\2\u00ce\u00cf\7\24\2\2\u00cf\u00d1\b\r\1\2\u00d0\u00cd\3"+
		"\2\2\2\u00d1\u00d4\3\2\2\2\u00d2\u00d0\3\2\2\2\u00d2\u00d3\3\2\2\2\u00d3"+
		"\u00d5\3\2\2\2\u00d4\u00d2\3\2\2\2\u00d5\u00d6\7\13\2\2\u00d6\u00d8\b"+
		"\r\1\2\u00d7\u00cc\3\2\2\2\u00d7\u00d8\3\2\2\2\u00d8\u00d9\3\2\2\2\u00d9"+
